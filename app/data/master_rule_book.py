...
MASTER_RULEBOOK = [
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<mark class=\"hl-beige\"><strong>Important:</strong> The Attack and Defense technology modification may not normally exceed a unit's Hull Size (9.2).</mark>"""),
        ],
    },
    {
        'id': '5-6',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: If the attacker has 10 combat-capable units and the defender has 5, the attacker may screen as many as 5 combat-capable units.</i>"""),
        ],
    },
    {
        'id': '5-7-1',
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""<mark class=\"hl-blue\">See Additional Terrain (25.0) for more combat effects.</mark>"""),
        ],
    },
    {
        'id': '5-9',
        ...
        'tables': False,
        'full_text': [
            _("""Retreat is a voluntary action. After the first round, a unit that can move may choose to retreat instead of firing when it would be its regular turn to fire. Retreat may require a player to place a new Group counter on the game board (that is, if one ship in a Group retreats, leaving the rest of the Group in the hex). Non-combat ships (5.4), Bases (8.1), <mark class=\"hl-blue\">Starbases (38.5), Defense Satellite Networks (14.0)</mark>, Shipyards (8.2), Titans (22.0), and <mark class=\"hl-blue\">Missiles (24.4)</mark> may not retreat. Retreats may not be conducted after all enemy space combat-capable ships have been destroyed or have retreated."""),
        ],
    },
    {
        'id': '5-9-1',
        ...
        'full_text': [
            ...
            _("""- It must retreat into a System that is <mark class=\"hl-blue\">closer</mark> to one of its Colonies than the hex that it is retreating from; this does not need to be the closest Colony. Closeness is determined counting hexes and ignoring intervening terrain and units."""),
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""<i>Precious resources vital to industry.</i>"""),
        ],
    },
    {
        'id': '6-7-1',
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""<i>A derelict spacecraft from an advanced civilization.</i>"""),
        ],
    },
    {
        'id': '6-8-1',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""Bases, <mark class=\"hl-blue\">Starbases, Defense Satellite Networks</mark>, Colonies, Colony Ships, Mines, Mining Ships, MS Pipelines, and Shipyards do not incur maintenance costs."""),
            _("""<i>EXAMPLE: A Cruiser Group has 3 ships in it. Each Cruiser has a maintenance cost of 2 CP (Hull Size of 2), so the Group costs 6 CP to maintain. The player subtracts that from their income and notes the remainder on their Production Sheet.</i>"""),
        ],
    },
    {
        'id': '7-3-2',
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""<i>This abstractly represents resources, supplies, intelligence, and capital spent to speed production schedules, etc.</i>"""),
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<mark class=\"hl-beige\">DESIGN NOTE: Other players will see you manipulate the counters, but you do not have to announce what you are building or scrapping.</mark>"""),
        ],
    },
    {
        'id': '7-7',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: During movement, a player colonizes a planet by placing their Colony Ship on top of the planet. During the subsequent Economic Phase, that planet delivers no CP, but the counter is flipped to its Colony side. In the next Economic Phase, that Colony would be worth 1 CP.</i>"""),
        ],
    },
    {
        'id': '7-7-2',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: Attack technology level 2 must be purchased before Attack technology level 3; and Attack technology 2 and 3 may not be purchased in the same Economic Phase.</i>"""),
            _("""Several technologies have had their costs adjusted since the initial release of <i>Space Empires</i>. These new costs should be used at all times – even if playing with only the base game."""),
        ],
    },
    {
        'id': '9-2',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: A player just purchased Ship Size level 3. That same Economic Phase they may purchase Cruisers (CA).</i>"""),
        ],
    },
    {
        'id': '9-5',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: a player has developed Shipyard technology level 2, and they have two Shipyards in the same hex. Those Shipyards may now build a total of 3 Hull Points worth of ships each Economic Phase.</i>"""),
        ],
    },
    {
        'id': '9-7',
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""Bases, <mark class=\"hl-blue\">Starbases, Defense Satellite Networks</mark>, and Shipyards are automatically and instantly upgraded to the latest technology levels without cost (limited to their Hull Size). Shipyards may even use a new level of Shipyard technology that was just purchased."""),
            _("""<mark class=\"hl-purple\"><strong>PLAY NOTE:</strong> For those who wish to avoid the bookkeeping required by this rule, the Instant Technology Upgrade optional rule removes it (30.0).</mark>"""),
        ],
    },
    {
        'id': '10-0',
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""<i>Merchant Ship Pipelines represent groups of slow-moving space vessels as well as navigational beacons and portions of space that have been charted and cleared for space travel.</i>"""),
        ],
    },
    {
        'id': '13-1',
    ...
    },
    {
        ...
        'tables': False,
        'full_text': [
            _("""<i>Fighter technology allows you to build Carriers (CV) and Fighter Squadrons. Point Defense technology applies only to Scouts, and only affects their attacks against Fighters.</i>"""),
        ],
    },
    {
        'id': '15-1',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: A hex could have one Carrier Group with a 2 under the counter and one Fighter Group with a 6 under the counter to represent two fully loaded Carriers.</i>"""),
        ],
    },
    {
        'id': '15-2-2',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: A player may not use Move 4 to move a CV and 3 Fighters two hexes to an empty CV and then have the second CV move 2 hexes with the 3 Fighters.</i>"""),
        ],
    },
    {
        'id': '15-2-5',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<mark class=\"hl-blue\">All Fighters that are Fighter 2 or 3 get +1 Defense against Point Defense (15.3).</mark>"""),
        ],
    },
    {
        'id': '15-3',
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<i>EXAMPLE: A Scout (E-Class, Attack Strength 3) with Point Defense technology level 1 (A6 vs. Fighters) plus Attack technology level 1 (+1 to Attack Strength) would fire on Fighters with an A7 and fire on non-Fighters with an E4.</i>"""),
        ],
    },
    {
        'id': '16-0',
