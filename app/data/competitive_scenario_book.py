...
SCENARIO_RULES = [
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""C5 Play Resource cards that are played before ships are revealed (Missed Rendezvous, Retreat When Engaged, and Alien Reinforcements)."""),
            _("""Raiders and Missed Rendezvous: If Missed Rendezvous causes a situation in which there are no ships equipped with Scanner until Round 2, there are three possibilities: 1. If the Raider side has nothing but Raiders and they are trying to avoid combat by staying cloaked after learning this, then the battle does"""),
            ...
            _("""C11 Play Cards after ships are revealed (Cancel Card–Red Squadron, Cancel Card–Sensor Blind Spot, Cancel Card–Concealed Minefield, 4 Heroic Ship Cards, 2 Forced System Shutdowns & Overconfidence)."""),
            _("""C12 Sweep Mines."""),
            ...
            _("""Play Coup card."""),
            _("""C24 Play Planetary Bombardment Cards."""),
            ...
            _("""C26 Play Ground Combat Cards (Heroic Ground Unit and Defending Familiar Terrain)."""),
            ...
            _("""E16 Players discard Resource Cards that they wish to use for their CP value. Players may also play the Research Breakthrough Card."""),
