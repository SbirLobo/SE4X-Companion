...
CSB_RULES = [
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""<strong>C5</strong>"""),
            _("""Play Resource cards that are played before ships are revealed (<span class="text-uppercase">Missed Rendezvous #84</span>, <span class="text-uppercase">Retreat When Engaged #107</span>, and <span class="text-uppercase">Alien Reinforcements #90</span>)."""),
            _("""<strong>Raiders and <span class="text-uppercase">Missed Rendezvous #84</span>:</strong> If <span class="text-uppercase">Missed Rendezvous #84</span> causes a situation in which there are no ships equipped with Scanner until Round 2, there are three possibilities:"""),
            ...
            _("""Note for #27: Only revealed if a mobile unit is in combat."""),
            _("""The following Empire Advantages have to be revealed if non-Ground Units from these Empires are in the battle: #31*, #32*, #33*, #34, #38, #40*, #42*, #43, #44, #45, #46, #47*, #50*, #51*, #52*, #53, #54*, #55*, #58*, #59*, #62*, #63*, #187*, #188."""),
            ...
            _("""<strong>C9</strong>"""),
            _("""The attacker declares if any of their Raiders that were avoiding combat by staying cloaked are going to join in the combat now instead. Any Raiders that do join the battle at this time also have to reveal their tech. The attacker declares if any of their units with <span class="text-uppercase">Anti-Sensor Hull</span> are turning off that technology for this battle. The attacker designates which units they are protecting with <span class="text-uppercase">Shield Projectors</span>."""),
            _("""<strong>C10</strong>"""),
            _("""The defender declares if any of their Raiders that were avoiding combat by staying cloaked are going to join in the combat now instead. Any Raiders that do join the battle at this time also have to reveal their tech. The defender designates which units they are protecting with <span class="text-uppercase">Shield Projectors</span>."""),
            _("""<strong>C11</strong>"""),
            _("""Play Cards after ships are revealed (Cancel Card–<span class="text-uppercase">Red Squadron #66</span>, Cancel Card–<span class="text-uppercase">Sensor Blind Spot #67</span>, Cancel Card–<span class="text-uppercase">Concealed Minefield #69</span>, 4 <span class="text-uppercase">Heroic Ship #70 #71 #72 #73</span> Cards, 2 <span class="text-uppercase">Forced System Shutdowns #94 #95</span> & <span class="text-uppercase">Overconfidence #103</span>)."""),
            _("""<strong>C12</strong>"""),
            _("""Sweep Mines."""),
            _("""<strong>C13</strong>"""),
            _("""Mines detonate."""),
            _("""<strong>C14</strong>"""),
            _("""The player with more units can determine which ones they wish to screen this round. Note that the <span class="text-uppercase">Shape Shifter #55</span> Empire Advantage may be revealed at this time to activate the once per game effect."""),
            _("""<strong>C15</strong>"""),
            _("""Ships equipped with Tractor Beam declare which ships they are preventing from retreating this round. Attacking player declares first."""),
            _("""<strong>C16</strong>"""),
            ...
            _("""<strong>C17</strong>"""),
            _("""<span class="text-uppercase">Horsemen of the Plains #46</span> may retreat."""),
            _("""<strong>C18</strong>"""),
            _("""<span class="text-uppercase">Celestial Knights #33</span> may declare a charge."""),
            _("""<strong>C19</strong>"""),
            _("""Screened ships are re-determined."""),
            _("""<span class="text-uppercase">Tractor beam</span> targets are re-determined."""),
            ...
            _("""<span class="text-uppercase">Horsemen of the Plains #46</span> may retreat."""),
            _("""<strong>C22</strong>"""),
            _("""<span class="text-uppercase">Celestial Knights #33</span> may declare a charge if they have not already done so."""),
            _("""<strong>C23</strong>"""),
            ...
            _("""<strong>C24</strong>"""),
            _("""Play <span class="text-uppercase">Planetary Bombardment #98 #99</span> Cards."""),
            _("""<strong>C25</strong>"""),
            _("""Conduct <span class="text-uppercase">Planetary Bombardment #98 #99</span> if no Mines remain."""),
            ...
            _("""<strong>C26</strong>"""),
            _("""Play Ground Combat Cards (<span class="text-uppercase">Heroic Ground Unit #75</span> and <span class="text-uppercase">Defending Familiar Terrain #76 #170</span>)."""),
            _("""<strong>C27</strong>"""),
            ...
            _("""<strong>E16</strong>"""),
            _("""Players discard Resource Cards that they wish to use for their CP value. Players may also play the <span class="text-uppercase">Research Breakthrough #77</span> Card."""),
            _("""<strong>E17</strong>"""),
