...
SCENARIO_RULES = [
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""A ship with Advanced Comm Array cannot React into a black hole hex if the enemy ship is attempting a Black Hole Slingshot. That ship can still React to the next hex the enemy ship enters, if that hex is adjacent to the ship making the Reaction Movement."""),
            _("""MOVEMENT"""),
            ...
            _("""Units may move from one hex to another at up to the maximum speed they are equipped with. This movement may be increased by MS Pipelines or Black Hole Slingshots, but not both. This movement may be reduced by entering various terrain types, hexes that contain enemy units, and hexes that are beside enemy units equipped with Advanced Comm Array. Ships use Exploration technology before moving. One or more Resource Cards may be played after Exploration tech is used but before any ship movement."""),
            ...
            _("""• Units without an Attack Strength and not in a Black Hole hex are not destroyed if friendly combat-capable units declare that they will use Advanced Comm Array to React into the hex."""),
            _("""COMBAT"""),
