...
CSB_RULES = [
    ...
    },
    {
        ...
        'full_text': [
            _("""B Player 1 Home System Markers"""),
            _("""Player 2 Home System Markers"""),
            _("""Player 1 Home System"""),
            _("""Player 2 Home System"""),
            _("""Markers"""),
            _("""Markers"""),
            _("""B B B"""),
            _("""B B"""),
            _("""Player 4 Home System"""),
            _("""Player 3 Home System"""),
            _("""Player 3 Home System Markers"""),
            _("""Player 4 Home System Markers"""),
            _("""Markers"""),
            _("""Markers"""),
            _("""B"""),
        ],
    ...
    },
    {
        ...
        'full_text': [
            ...
            _("""• The attacker states that they have Raiders and want to continue moving. • The defender states that they have Scanner 1 (and the attacker must stop) or that they lack Scanner 1 (and the attacker may continue moving). • If the defender stated that they had Scanner 1 the attacker may declare Cloaking 2. • The defender states that they have Scanner 2 (and that the attacker must stop) or that they lack Scanner 2 (and the attacker may continue moving)."""),
            ...
            _("""Black Hole Survival Checks: These happen before Reaction Movement is declared and before non-combat ships are destroyed."""),
            _("""A ship with <span class="text-uppercase">Advanced Comm Array #28</span> cannot React into a black hole hex if the enemy ship is attempting a Black Hole Slingshot. That ship can still React to the next hex the enemy ship enters, if that hex is adjacent to the ship making the Reaction Movement."""),
            _("""MOVEMENT"""),
            ...
            _("""Units without an Attack Strength are destroyed if caught alone in a hex by combat-capable enemy units. No information about the enemy units is revealed by this except for the fact that they are armed. There are two exceptions to this rule: • Units without an Attack Strength are not destroyed if they are in a Black Hole hex and all of the enemy units fail their Black Hole survival checks."""),
            _("""Raiders vs. Scanners: When the attacker moves into a hex with enemy units and the attacker has Raiders present that they wish to continue moving, the following happens. (Note that though these rules refer to Raiders, they also cover any other ships equipped with Cloaking.)"""),
            _("""• Units without an Attack Strength and not in a Black Hole hex are not destroyed if friendly combat-capable units declare that they will use <span class="text-uppercase">Advanced Comm Array #28</span> to React into the hex."""),
            _("""COMBAT"""),
            _("""C1 Combat-capable units or Colonies from two opposing sides are in the same hex after a player has finished moving."""),
            _("""C2 Defender may move ships by Reaction Movement if they have the technology needed."""),
            _("""C3 • Attacker declares whether they have Cloaking 1 or not."""),
            _("""• Defender declares whether they have Scanner 1 or not. • If defender has Scanner 1, attacker declares if they have Cloaking 2 or not. • If attacker declared they have Cloaking 2, then defender declares if they have Scanner 2 or not."""),
            _("""C4 • Defender declares whether they have Cloaking 1 or not. • Attacker declares that they have Scanner 1 or not. • If attacker has Scanner 1, defender declares if they have Cloaking 2 or not. • If defender declared they have Cloaking 2 then attacker declares if they have Scanner 2 or not."""),
            _("""C5 Play Resource cards that are played before ships are revealed (<span class="text-uppercase">Missed Rendezvous #84</span>, <span class="text-uppercase">Retreat When Engaged #107</span>, and <span class="text-uppercase">Alien Reinforcements #90</span>)."""),
            _("""Raiders and <span class="text-uppercase">Missed Rendezvous #84</span>: If <span class="text-uppercase">Missed Rendezvous #84</span> causes a situation in which there are no ships equipped with Scanner until Round 2, there are three possibilities: 1. If the Raider side has nothing but Raiders and they are trying to avoid combat by staying cloaked after learning this, then the battle does"""),
            _("""not start until the Scanner-equipped ship arrives and Round 2 will count as Round 1 for most purposes. The Raiders will still be able to retreat at the first D-Class firing opportunity they get. 2. If the Raider side has Raiders that are trying to avoid combat by staying cloaked AND ships that are not Raiders, then Round 1 is fought as normal, but the Raiders cannot fire or be fired at. In Round 2, the Raiders can be fired at and can retreat or fire at the first D-Class firing opportunity they get. 3. If the Raiders declare that they want the +1 in Round 1, then Round 1 is fought as normal. The Raiders will fire as A-Class Units with a +1 to their Attack Strength. In Round 2, the Raiders will be treated as D-Class Units."""),
            _("""from these Empires are in the battle: 31*, 32*, 33*, 34, 38, 40*, 42*, 43, 44, 45, 46, 47*, 50*, 51*, 52*, 53, 54*, 55*, 58*, 59*, 62*, 63*, 187*, 188."""),
            _("""Note for 31 & 32: Boarding Ships do not force a reveal."""),
            ...
            _("""Note for 52: A Mine must be present to force a reveal."""),
            _("""Note for 54: A unit that mounts Exploration 1 must be present to force the reveal."""),
            _("""C7 Attacking Raiders that have not had their cloak nullified may retreat. Defending Raiders that have not had their cloak nullified may retreat."""),
            _("""Note for 55: Reveal is optional to avoid revealing technology."""),
            _("""Note for 58: A Shipyard or Base must be present to force the reveal."""),
            _("""C8 Both sides reveal what tech is on their units and some Empire Advantages and Alien Technology Cards are revealed. Both sides reveal the Experience levels that their units have."""),
            _("""Note for 59: Fighters and A-Class units do not force a reveal."""),
            _("""Note for 62: Only ships that benefit from this card force a reveal."""),
            _("""All special abilities that Unique Ships and Advanced Flagships mount must be revealed."""),
            _("""Note for 63: Only ships that benefit from this card force a reveal."""),
            _("""Note for 187: A Titan must be present to force a reveal."""),
            _("""Ground 2, Terraforming 1-2, and Military Academy 1 are not revealed in space combat. All other technology is revealed."""),
            _("""C9 The attacker declares if any of their Raiders that were avoiding combat by staying cloaked are going to join in the combat now instead. Any Raiders that do join the battle at this time also have to reveal their tech. The attacker declares if any of their units with Anti-Sensor Hull are turning off that technology for this battle. The attacker designates which units they are protecting with Shield Projectors."""),
            _("""The following Alien Tech Cards must be revealed if a unit mounts them:"""),
            _("""2, 3, 5, 10, 11, 12, 13, 14, 15, 16, 22, 24, 25, 26, 27*, 28, 29, 30, 56, 183, 185, 186, 282, 283."""),
            _("""Note for 27: Only revealed if a mobile unit is in combat. The following Empire Advantages have to be revealed if non-Ground Units"""),
            _("""C10 The defender declares if any of their Raiders that were avoiding combat by staying cloaked are going to join in the combat now instead. Any Raiders that do join the battle at this time also have to reveal their tech. The defender designates which units they are protecting with Shield Projectors."""),
            _("""C11 Play Cards after ships are revealed (Cancel Card–<span class="text-uppercase">Red Squadron #66</span>, Cancel Card–<span class="text-uppercase">Sensor Blind Spot</span>, Cancel Card–<span class="text-uppercase">Concealed Minefield</span>, 4 <span class="text-uppercase">Heroic Ship #70 #71 #72 #73</span> Cards, 2 <span class="text-uppercase">Forced System Shutdowns #94 #95</span> & <span class="text-uppercase">Overconfidence #103</span>)."""),
            _("""C12 Sweep Mines."""),
            _("""C13 Mines detonate."""),
            _("""C14 The player with more units can determine which ones they wish to screen this round. Note that the Shape Shifter Empire Advantage may be revealed at this time to activate the once per game effect."""),
            _("""C15 Ships equipped with Tractor Beam declare which ships they are preventing from retreating this round. Attacking player declares first."""),
            _("""C16 Round 1 of combat is conducted as laid out in the rules."""),
            ...
            _("""A-Class rated defenders with Tactics 3 will fire first."""),
            _("""player who lost the Colony must reveal their Production Sheet to the capturing player. Based on where the planet is on the map, the capturing player may steal one or two technologies that the other player has researched."""),
            ...
            _("""Play <span class="text-uppercase">Coup #106</span> card."""),
            _("""C24 Play <span class="text-uppercase">Planetary Bombardment #98 #99</span> Cards."""),
            _("""C25 Conduct Planetary Bombardment if no Mines remain."""),
            ...
            _("""E5 In reverse Player order, the players may play Resource Cards."""),
            _("""C26 Play Ground Combat Cards (Heroic Ground Unit and <span class="text-uppercase">Defending Familiar Terrain #76 #170</span>)."""),
            _("""E6 In reverse Player order, the players may discard and activate Cancel Cards."""),
            _("""C27 Conduct Ground Combat if no Mines remain."""),
            ...
            _("""E14 Players adjust Colony counters to reflect growth."""),
            _("""E15 Players announce bids for turn order."""),
            _("""E16 Players discard Resource Cards that they wish to use for their CP value. Players may also play the <span class="text-uppercase">Research Breakthrough #77</span> Card."""),
            _("""E17 Players discard Resource Cards that are over the hand limit of six cards."""),
