...
DEEP_SPACE_PLANET_ATTRIBUTES = [
    ...
    },
    {
        ...
        'errata': _("""[g]Text corrected per PAC Planets: added '(including <span class="text-uppercase">Longbowmen #59</span> ships)'. Note: PAC Planets omits '(this supersedes any effects from cards)' — Card Manifest includes it; text follows Card Manifest.[/g]"""),
    },
    {
        'number': 13,
        'name': _("""[b]Doomed[/b]"""),
