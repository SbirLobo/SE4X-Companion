...
DEEP_SPACE_PLANET_ATTRIBUTES = [
    ...
    },
    {
        ...
        'errata': _("""[g]Text corrected per PAC Planets: 'does not have' — Card Manifest reads 'has Ground Combat 2 no unit is produced' (inverted condition, likely a typo in the Card Manifest).[/g]"""),
    },
    {
        'number': 10,
        'name': _("""[b]Defensible[/b]"""),
        'ships': 4,
        'heavy_infantry': 0,
        'quantity': 1,
        'PAC_planets_text': [
    ...
    },
    {
        ...
        'quantity': 1,
        'PAC_planets_text': [
            _("""All attacking ships (including <span class="text-uppercase">Longbowmen [g][#59][/g]</span> ships) in this hex fire as if they are E-Class. Boarding Ships still fire as F-Class. If a Replicator Colony is placed on this planet, remove this Attribute."""),
            ],
        'card_manifest_text': [
        ...
        'errata': _("""[g]Text corrected per PAC Planets: added '(including <span class="text-uppercase">Longbowmen [g][#59][/g]</span> ships)'. Note: PAC Planets omits '(this supersedes any effects from cards)' — Card Manifest includes it; text follows Card Manifest.[/g]"""),
    },
    {
        'number': 13,
        'name': _("""[b]Doomed[/b]"""),
...
this planet, remove this Attribute."""),
        ...
        'errata': _("""[g]Text replaced per PAC Planets: '3 Hull Points of Shipyard build capacity'.[/g]"""),
    },
    {
        'number': 15,
        'name': _("""[b]Spaceport[/b]"""),
        'ships': 0,
        'heavy_infantry': 0,
        'quantity': 1,
        'PAC_planets_text': [
        ...
        'errata': _("""[g]Text corrected per PAC Planets: Replicator rule reworded to match source.[/g]"""),
    },
    {
        'number': 16,
        'name': _("""[b]Research[/b]"""),
    ...
    },
    {
        ...
        'errata': _("""[g]PAC Planets reads 'take the planet counter as a reminder' — Card Manifest reads 'the counter is removed and kept as a reminder'; text follows Card Manifest.[/g]"""),
    },
    {
        'number': 21,
        'name': _("""[b]Accurate[/b]"""),
    ...
    },
    {
        ...
        'errata': _("""[g]PAC Planets reads 'but from training at the Jedun temple' — Card Manifest reads 'but rather a consequence of the disciplined training the crew received at the temple'; text follows Card Manifest.[/g]"""),
    },
    {
        'number': 26,
        'name': _("""[b]Telepathic[/b]"""),
        'ships': 5,
        'heavy_infantry': 1,
        'quantity': 1,
        'PAC_planets_text': [
